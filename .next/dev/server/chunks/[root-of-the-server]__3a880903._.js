...
"[project]/personal-finance-system/app/api/auth/register/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        if (!userRole) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$personal$2d$finance$2d$system$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Default role not found. Please seed the database first."
            }, {
                status: 500
            });
        }
        // Hash password
        const hashedPassword = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$personal$2d$finance$2d$system$2f$lib$2f$db$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hashPassword"])(password);
        // Create user
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3a880903._.js.map