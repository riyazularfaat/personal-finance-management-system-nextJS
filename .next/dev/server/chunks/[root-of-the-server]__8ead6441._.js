...
"[project]/personal-finance-system/app/api/auth/me/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const roleMenuAccessCollection = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$personal$2d$finance$2d$system$2f$lib$2f$db$2f$collections$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRoleMenuAccessCollection"])();
        const menusCollection = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$personal$2d$finance$2d$system$2f$lib$2f$db$2f$collections$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getMenusCollection"])();
        const accessList = await roleMenuAccessCollection.find({
            roleId: user.roleId,
            isView: true
        }).toArray();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8ead6441._.js.map