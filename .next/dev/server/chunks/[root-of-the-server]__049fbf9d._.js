...
"[project]/personal-finance-system/lib/db/auth-middleware.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/personal-finance-system/app/api/dashboard/stats/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$personal$2d$finance$2d$system$2f$lib$2f$db$2f$collections$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/personal-finance-system/lib/db/collections.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$personal$2d$finance$2d$system$2f$lib$2f$db$2f$auth$2d$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/personal-finance-system/lib/db/auth-middleware.ts [app-route] (ecmascript)");
;
;
;
async function GET(request) {
    try {
        const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$personal$2d$finance$2d$system$2f$lib$2f$db$2f$auth$2d$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCurrentUser"])(request);
        if (!user) {
        ...
        const transactionsCollection = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$personal$2d$finance$2d$system$2f$lib$2f$db$2f$collections$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getTransactionsCollection"])();
        const accountsCollection = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$personal$2d$finance$2d$system$2f$lib$2f$db$2f$collections$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAccountsCollection"])();
        const categoriesCollection = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$personal$2d$finance$2d$system$2f$lib$2f$db$2f$collections$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCategoriesCollection"])();
        // Get all user data
        ...
        // Recent transactions
        const recentTransactions = transactions.sort((a, b)=>b.date.getTime() - a.date.getTime()).slice(0, 5).map((t)=>{
        ...
        // Category breakdown
        const categoryBreakdown = categories.filter((c)=>c.type === "expense").map((category)=>{
            const categoryTransactions = transactions.filter((t)=>t.type === "expense" && t.categoryId.equals(category._id));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__049fbf9d._.js.map